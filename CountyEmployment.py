...
class CountyInfo():
    ...
    def get_employment_info(self, url):
        options = Options()
        ...
        driver.get(url)
        counties_list = [info.find_element_by_css_selector('td.align-left:nth-of-type(1) > a').get_attribute('textContent').strip() for info in driver.find_element_by_id('datatable1').find_elements_by_css_selector('tbody > tr')]
